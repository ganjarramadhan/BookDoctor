...
public class MyDatePickerDialog extends DialogFragment implements
    ...
    private List<Integer> listOfAvailableDay;
    ...
    public interface OnDateSetListener {
         ...
         */
        void onDateSet(MyDatePickerDialog view, int year, int monthOfYear, int dayOfMonth);
    }
    ...
    public static MyDatePickerDialog newInstance(OnDateSetListener callBack, int year,
                                               int monthOfYear,
                                               int dayOfMonth, List<Integer> listOfAvailableDay) {
        MyDatePickerDialog ret = new MyDatePickerDialog();
        ret.initialize(callBack, year, monthOfYear, dayOfMonth, listOfAvailableDay);
        return ret;
    }

    public void initialize(OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth,
                           List<Integer> listOfAvailableDay) {
        mCallBack = callBack;
        mCalendar.set(Calendar.YEAR, year);
        mCalendar.set(Calendar.MONTH, monthOfYear);
        mCalendar.set(Calendar.DAY_OF_MONTH, dayOfMonth);
        this.listOfAvailableDay = listOfAvailableDay;
    }
    ...
    public void onYearSelected(int year) {
        ...
        if (listOfAvailableDay != null){
            for (int i=0; i<7; i++){
                if (listOfAvailableDay.contains(mCalendar.get(Calendar.DAY_OF_WEEK))) break;
    ...
    @Override
    public void registerOnDateChangedListener(com.wdullaer.materialdatetimepicker.date.DatePickerDialog.OnDateChangedListener listener) {

    }

    @Override
    public void unregisterOnDateChangedListener(com.wdullaer.materialdatetimepicker.date.DatePickerDialog.OnDateChangedListener listener) {
    ...
    public boolean isOutOfRange(int year, int month, int day) {
        ...
        if(!listOfAvailableDay.contains(c.get(Calendar.DAY_OF_WEEK))){
            return true;
        }
...
//
//        return listOfAvailableDay.contains(calendar.get(Calendar.DAY_OF_WEEK));
    }
    ...
    public void notifyOnDateListener() {
        if (mCallBack != null) {
            mCallBack.onDateSet(MyDatePickerDialog.this, mCalendar.get(Calendar.YEAR),
