...
public class BookingRestClient {
    ...
    private static BookingRestInterface REST_CLIENT;

    static {
        setupRestClient();
    }

    private BookingRestClient() {
    }

    public static BookingRestInterface get() {
        return REST_CLIENT;
    }
    ...
    private static void setupRestClient() {
        ...
        REST_CLIENT = restAdapter.create(BookingRestInterface.class);
